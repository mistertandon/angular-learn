...
"""
emp_i: Employee = Employee('Prabhash', 'Tandon', 100)
emp_i.raise_amount = 1.10
emp_i.apply_raise()
emp_i.display_salary()

emp_ii: Employee = Employee('Jiyanshi', 'Tandon', 100)
emp_ii.apply_raise()
...
emp_iii: Employee = Employee('Parvesh', 'Tandon', 100)
emp_iii.apply_raise()
emp_iii.display_salary()

emp_iv: Employee = Employee('Parveen', 'Tandon', 100)
emp_iv.apply_raise()
